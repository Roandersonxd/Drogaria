...
public class MainListaProdutos extends ActionBarActivity {
    ...
    HashMap<String,Produto> func = new HashMap<>();
    Produto funnnn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            for (int i = 0; i <client.getListaProduto().size(); i++) {
                ...
                Produto fun1= new Produto();

                fun1.setCodigo(Integer.parseInt(Id_Cliente));

                fun1.setDescricao(Nome);
                //
                cli.add(Nome);
        ...
        mToolbar.setTitle("Lista de produtos");
        ...
        mToolbarBottom.findViewById(R.id.iv_settings).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainListaProdutos.this, "Settings pressed", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public AdapterView.OnItemClickListener lista(final Context  context){
        return(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                switch (position){
                    case 0:
                        intent = new Intent(context,Produto.class);
